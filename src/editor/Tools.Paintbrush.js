...
Tools.Paintbrush = function (wickEditor) {
    ...
    this.getCursorImage = function () {
        ...
        context.fillStyle = invertColor(wickEditor.settings.drawingColor);
        context.fill();

        context.beginPath();
        context.arc(centerX, centerY, radius, 0, 2 * Math.PI, false);
        context.fillStyle = wickEditor.settings.drawingColor;
        context.fill();
    ...
    var potraceFabricPath = function (pathFabricObject, callback) {
        ...
        pathFabricObject.cloneAsImage(function(clone) {
            var img = new Image();
            img.onload = function () {
                potraceImage(img, callback, wickEditor.settings.drawingColor);
            };
